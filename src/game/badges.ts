...
export const BADGES: BadgeDefinition[] = [
  ...
  },
  {
    ...
    icon: "Ne",
    iconLucide: FlaskConical,
    requiredAtomicNumbers: [10],
  },
  {
    id: "silicon-circuit",
    group: "milestones",
    name: "Silicon Circuit",
    description: "Discover Silicon.",
    icon: "Si",
    iconLucide: Hexagon,
    requiredAtomicNumbers: [14],
  },
  {
    id: "calcium-core",
    group: "milestones",
    name: "Calcium Core",
    description: "Discover Calcium.",
    icon: "Ca",
    iconLucide: Mountain,
    requiredAtomicNumbers: [20],
  },
  {
    id: "copper-spark",
    group: "milestones",
    name: "Copper Spark",
    description: "Discover Copper.",
    icon: "Cu",
    iconLucide: Zap,
    requiredAtomicNumbers: [29],
  },
  {
    id: "xenon-flash",
    group: "milestones",
    name: "Xenon Flash",
    description: "Discover Xenon.",
    icon: "Xe",
    iconLucide: Beaker,
    requiredAtomicNumbers: [54],
  },
  {
    id: "platinum-elite",
    group: "milestones",
