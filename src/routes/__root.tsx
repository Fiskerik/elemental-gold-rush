...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Elemental Gold Rush is a mobile puzzle game where players merge elements to progress through the periodic table." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Elemental Gold Rush is a mobile puzzle game where players merge elements to progress through the periodic table." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Elemental Gold Rush is a mobile puzzle game where players merge elements to progress through the periodic table." },
